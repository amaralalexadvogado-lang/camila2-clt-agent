[README.md](https://github.com/user-attachments/files/27780427/README.md)
...
- Fluxo: vínculo → dados → operador/digitação.
- Gera nota/card de liberação ao operador logo após dados pessoais confirmados; não pedir documentos nesta etapa.
